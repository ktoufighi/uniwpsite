<?php get_header(); ?>
  ...
  <div class="page-banner__bg-image" style="background-image: url(<?php echo get_theme_file_uri('/images/library-hero.jpg') ?>);"></div>
    <div class="page-banner__content container t-center c-white">
      <h1 class="headline headline--large">Welcome! dudes</h1>
  ...
  <div class="full-width-split group">
      ...
      <div class="full-width-split__inner">
        ...
        <?php
          ...
          $homepageEvents = new WP_Query(array(
            ...
            'meta_query' => array(
              array(
                //event date is our key
                'key' => 'date',
                // to today's date if its bigger or equal display it
                'compare' => '>=',
                // value is today's date
                'value' => $today,
                // the type being compared is a numeric value
                'type' => 'numeric'
              )
            )
    ...
    <div class="full-width-split__two">
      <div class="full-width-split__inner">
        ...
        <?php
        // instance of an object beloging to a class WP_Query in WP
